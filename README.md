...
1. Clone the repository:
    ```bash
    git clone https://github.com/aniketkolapkar778-code/python_emp_project.git
    ```
...
4. Update **database credentials** in `app.py` if needed:
    ```python
    conn = pymysql.connect(user='root', host='localhost', password='Aniket@2000', database='emp_db')
    ```
